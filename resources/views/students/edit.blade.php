		...
		<div class="col-8">
			...
			@csrf	
				...
				<div class="form-group">
					...
					<input type="text" class="form-control @error('nrp') is-invalid @enderror" id="nrpp" placeholder="Masukan Nrp" name="nrp" value="{{$students->nrp}}">
					@error('nrp')
						<div class="invalid-feedback">{{$message}}</div>
					@enderror
				</div>
				<div class="form-group">
					...
					<input type="text" class="form-control @error('emaill') is-invalid @enderror" id="email" placeholder="Masukan Email" name="email" value="{{$students->email}}">
					@error('email')
						<div class="invalid-feedback">{{$message}}</div>
					@enderror
				</div>
